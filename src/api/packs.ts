...
const TASK_PACK_WEIGHTS: Record<TaskTaxonomy, Partial<Record<ContextPackType, number>>> = {
  ...
  implementation: { function_context: 1.8, module_context: 1.0, change_impact: 0.8, decision_context: 0.6, pattern_context: 0.9, similar_tasks: 0.7, doc_context: 0.2, project_understanding: 0.2 },
};
