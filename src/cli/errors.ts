...
export const ERROR_SUGGESTIONS: Record<CliErrorCode, string> = {
  ...
  QUERY_TIMEOUT: 'Retry with a larger timeout via `--timeout <ms>` after running `librainian doctor --heal`.',
  STORAGE_LOCKED: 'Wait for active indexing to finish or run `librainian doctor --heal` to clear stale locks.',
