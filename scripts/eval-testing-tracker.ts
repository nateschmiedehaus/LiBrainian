...
const args = parseArgs({
  options: {
    ...
    markdownOut: { type: 'string', default: 'docs/librainian/TESTING_TRACKER.md' },
...
const markdownOutPath = resolvePath(args.values.markdownOut, 'docs/librainian/TESTING_TRACKER.md');
