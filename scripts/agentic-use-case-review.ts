...
const args = parseArgs({
  options: {
    ...
    matrixPath: { type: 'string', default: 'docs/librainian/USE_CASE_MATRIX.md' },
...
const matrixPath = path.resolve(process.cwd(), args.values.matrixPath ?? 'docs/librainian/USE_CASE_MATRIX.md');
